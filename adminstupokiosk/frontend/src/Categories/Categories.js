...
import CategoriesCreate from "./CCreate";
...
const Categories = ({ setError }) => {
  ...
  return (
    <div className="Categories">
      <CategoriesCreate setDoFetchList={setDoFetchList} />
      <CategoriesUpdate setDoFetchList={setDoFetchList} edit={edit} setEdit={setEdit} />
      <CategoriesDestroy handleDestroy={handleDestroy} />
